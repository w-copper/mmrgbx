...
from .cmx_dualswin import FeatureFusionModule as FFM
from .cmx_dualswin import FeatureRectifyModule as FRM
import math
...
class CMXTransformer(nn.Module):
    def __init__(
        self,
        img_size=224,
        in_chans=3,
...
class CMXTransformerB0(CMXTransformer):
    def __init__(self, img_size=224, **kwargs):
        super(CMXTransformerB0, self).__init__(
            img_size=img_size,
...
@MODELS.register_module()
class CMXTransformerB1(CMXTransformer):
    def __init__(self, img_size=224, **kwargs):
        super(CMXTransformerB1, self).__init__(
            img_size=img_size,
...
@MODELS.register_module()
class CMXTransformerB2(CMXTransformer):
    def __init__(self, img_size=224, **kwargs):
        super(CMXTransformerB2, self).__init__(
            img_size=img_size,
            embed_dims=[64, 128, 320, 512],
            num_heads=[1, 2, 5, 8],
            mlp_ratios=[4, 4, 4, 4],
...
@MODELS.register_module()
class CMXTransformerB3(CMXTransformer):
    def __init__(self, img_size=224, **kwargs):
        super(CMXTransformerB3, self).__init__(
            img_size=img_size,
            embed_dims=[64, 128, 320, 512],
            num_heads=[1, 2, 5, 8],
            mlp_ratios=[4, 4, 4, 4],
...
@MODELS.register_module()
class CMXTransformerB4(CMXTransformer):
    def __init__(self, img_size=224, **kwargs):
        super(CMXTransformerB4, self).__init__(
            img_size=img_size,
            embed_dims=[64, 128, 320, 512],
            num_heads=[1, 2, 5, 8],
            mlp_ratios=[4, 4, 4, 4],
...
@MODELS.register_module()
class CMXTransformerB5(CMXTransformer):
    def __init__(self, img_size=224, **kwargs):
        super(CMXTransformerB5, self).__init__(
            img_size=img_size,
            embed_dims=[64, 128, 320, 512],
            num_heads=[1, 2, 5, 8],
            mlp_ratios=[4, 4, 4, 4],
